...
public class PurchaseReport extends javax.swing.JFrame {
    ...
    private void getData() throws SQLException {
        try{
            ...
            try (ResultSet stockResult = stm.executeQuery("SELECT product.name AS product_name, purchase_date, "
                + "purchase.qty AS purchase_qty, customer.name AS customer_name, amount FROM `purchase`\n"
    ...
    private void initComponents() {
        ...
        purchaseReportTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ", "Date", "Qty", "Purchase by", "Amount"
            }
        ) {
