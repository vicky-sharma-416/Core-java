...
public class SalesReport extends javax.swing.JFrame {
    ...
    public SalesReport() throws SQLException {
        initComponents();
    ...
    private void getData() throws SQLException {
        try{
            ...
            try (ResultSet stockResult = stm.executeQuery("SELECT product.name AS product_name, sales_date, "
                + "sales.qty AS sales_qty, customer.name AS customer_name, amount FROM `sales`\n"
                ...
                while(stockResult.next()){
                    Object[] data0 = {stockResult.getString(1), stockResult.getDate(2), stockResult.getInt(3), 
                        stockResult.getString(4), stockResult.getInt(5)
                    };
                    model.addRow(data0);
                }
            }
    ...
    private void initComponents() {
        ...
        purchaseReportTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ", "Date", "Qty", "Sales by", "Amount"
            }
        ) {
